...
public class GenerateAPI {
    ...
    private static void createAndShowGUI() {
        JFrame frame = new JFrame("AutoDriver - API");
        ...
        JButton runUAButton = new JButton("Generate API Automation Scripts");
        JButton runUITestsButton = new JButton("Run API Tests");
        ...
        inputPanel.add(new JLabel("Enter Manual API Testcases:"));
        ...
        runUAButton.addActionListener(e -> {
            ...
            try {
                String fileName = basePath + "apitestcases.txt";
            ...
            runTestNGSuite(basePath + "generateapi.xml", "generateapi.xml");
        });

        runUITestsButton.addActionListener(e -> {
            // Run the UI tests using the existing TestNG XML execution logic
            runTestNGSuite(basePath + "runapi.xml", "runapi.xml");
        });
